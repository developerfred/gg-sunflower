...
export class SunflowerLand__getFarmResultValue0Struct extends ethereum.Tuple {
  get owner(): Address {
...
export class SunflowerLand__getFarmsResultValue0Struct extends ethereum.Tuple {
  get owner(): Address {
    return this[0].toAddress();
  }
...
export class SunflowerLand extends ethereum.SmartContract {
  static bind(address: Address): SunflowerLand {
    return new SunflowerLand("SunflowerLand", address);
  }
  ...
  gameApprove(to: Address, tokenId: BigInt): boolean {
    let result = super.call(
      "gameApprove",
      "gameApprove(address,uint256):(bool)",
      [
  ...
  try_gameApprove(to: Address, tokenId: BigInt): ethereum.CallResult<boolean> {
  ...
  gameBurn(tokenId: BigInt): boolean {
    let result = super.call("gameBurn", "gameBurn(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
  ...
  try_gameBurn(tokenId: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("gameBurn", "gameBurn(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  gameTransfer(from: Address, to: Address, tokenId: BigInt): boolean {
    let result = super.call(
      "gameTransfer",
      "gameTransfer(address,address,uint256):(bool)",
      [
  ...
  getFarm(tokenId: BigInt): SunflowerLand__getFarmResultValue0Struct {
    let result = super.call(
      "getFarm",
      "getFarm(uint256):((address,address,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );

    return changetype<SunflowerLand__getFarmResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getFarm(
    tokenId: BigInt
  ): ethereum.CallResult<SunflowerLand__getFarmResultValue0Struct> {
    let result = super.tryCall(
      "getFarm",
      "getFarm(uint256):((address,address,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<SunflowerLand__getFarmResultValue0Struct>(value[0].toTuple())
    );
  }

  getFarms(account: Address): Array<SunflowerLand__getFarmsResultValue0Struct> {
    let result = super.call(
      "getFarms",
      "getFarms(address):((address,address,uint256)[])",
      [ethereum.Value.fromAddress(account)]
    );

    return result[0].toTupleArray<SunflowerLand__getFarmsResultValue0Struct>();
  }

  try_getFarms(
    account: Address
  ): ethereum.CallResult<Array<SunflowerLand__getFarmsResultValue0Struct>> {
    let result = super.tryCall(
      "getFarms",
      "getFarms(address):((address,address,uint256)[])",
      [ethereum.Value.fromAddress(account)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<SunflowerLand__getFarmsResultValue0Struct>()
    );
  }
  ...
  mint(account: Address): boolean {
    let result = super.call("mint", "mint(address):(bool)", [
      ethereum.Value.fromAddress(account)
    ]);
  ...
  try_mint(account: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("mint", "mint(address):(bool)", [
      ethereum.Value.fromAddress(account)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
